...
class ChatStore:
    ...
    def ping(self) -> bool:
        ...
        try:
            ...
            # Nuốt MỌI exception: /readyz cần một câu trả lời true/false, một
    ...
    def add_turn(self, client_id: str, role: str, content: str) -> None:
        ...
        # -N đến -1 = N phần tử CUỐI danh sách, tức là mới nhất.
    ...
    def history(self, client_id: str) -> list[dict]:
        ...
        """
        # lrange trên key chưa tồn tại trả về [] chứ không lỗi.
        return [
            json.loads(item)
